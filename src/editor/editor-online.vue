      ...
      <el-row>
        ...
        <el-col :span="12">
          <div>
            ...
            <el-button type="text" @click="elementUIDoc"
              >element-ui 文档</el-button
            >
          </div>
        </el-col>
        <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    runCode() {
      ...
      parseObj.script = parseObj.script.replace(/import[^\;]*\;/gim, "");
      parseObj.script = parseObj.script.replace(/components[^\}]*\}\,/gim, "");

      parseObj.script = Babel.transform(parseObj.script, {
        presets: ["es2015"],
      }).code;
